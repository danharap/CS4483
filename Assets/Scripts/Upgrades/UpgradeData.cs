...
public static class UpgradeCatalogue
{
    ...
    {
        new UpgradeData { ID = "dmg",       DisplayName = "+Damage",        Description = "Projectile damage +10%",        Rarity = UpgradeRarity.Common   },
        new UpgradeData { ID = "atkspd",    DisplayName = "+Attack Speed",  Description = "Fire rate +10%",                Rarity = UpgradeRarity.Common   },
        ...
        new UpgradeData { ID = "dash",      DisplayName = "+Agility",       Description = "Dash cooldown -15%",            Rarity = UpgradeRarity.Uncommon },
    };
